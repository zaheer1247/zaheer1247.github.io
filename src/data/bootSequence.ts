...
export const bootSequence: BootStep[] = [
  ...
  { id: 'node-1-not-ready', after: 700, phase: 'Joining worker nodes', reason: 'NodeRegistered', resource: 'node/control-plane-01', message: 'Node registered with cluster.', kind: 'node', state: 'not-ready' },
  { id: 'node-1-init', after: 450, phase: 'Joining worker nodes', reason: 'NodeInitializing', resource: 'node/control-plane-01', message: 'Kubelet reporting initialization status.', kind: 'node', state: 'initializing' },
  { id: 'node-1-ready', after: 500, phase: 'Joining worker nodes', reason: 'NodeReady', resource: 'node/control-plane-01', message: 'Node transitioned to Ready.', kind: 'node', state: 'ready' },
  { id: 'node-2-ready', after: 650, phase: 'Joining worker nodes', reason: 'NodeReady', resource: 'node/workload-devops-01', message: 'Node transitioned to Ready.', kind: 'node', state: 'ready' },
  { id: 'node-3-ready', after: 550, phase: 'Joining worker nodes', reason: 'NodeReady', resource: 'node/workload-sre-01', message: 'Node transitioned to Ready.', kind: 'node', state: 'ready' },
  ...
  { id: 'pods-running', after: 650, phase: 'Scheduling portfolio workloads', reason: 'ContainerStarted', resource: 'pods/portfolio-workloads', message: 'Four supporting workload pods are running.', kind: 'pod', state: 'running' },
