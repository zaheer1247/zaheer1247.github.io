...
export const pods: PortfolioPod[] = [
  { id: 'profile', name: 'profile-service', namespace: 'profile', kind: 'profile', status: 'healthy', nodeId: 'identity', title: 'Platform Architect', summary: 'A career built from quality engineering to dependable cloud platforms.', technologies: ['Kubernetes', 'Cloud', 'SRE'] },
  { id: 'career-story', name: 'career-story', namespace: 'profile', kind: 'profile', status: 'healthy', nodeId: 'identity', title: 'Career story', summary: 'Quality engineering to cloud platform architecture.', technologies: ['Leadership', 'Strategy'] },
